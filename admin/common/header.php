...
<?php
// print_r($currentPage);
$clientName = "Jainam Jain";
$desc = "This website is designed by Jainam Jain.";
switch ($currentPage) {
    case 'login.php':
        $keywords    = 'Nivine Tech';
    ...
    case 'addNewCars.php':
        $keywords    = 'Nivine Tech';
        $title       = 'Add New Car Page - ' . $clientName;
        $description = $desc;
        break;

    case 'manageCarDetails.php':
        $keywords    = 'Nivine Tech';
        $title       = 'Manage Car Details Page - ' . $clientName;
        $description = $desc;
        break;
...
<script>
    ...
    var loadFile = function(event) {
        var carPhotoImagePreview = document.getElementById('carPhotoImagePreview');
        carPhotoImagePreview.src = URL.createObjectURL(event.target.files[0]);
        carPhotoImagePreview.onload = function() {
            URL.revokeObjectURL(carPhotoImagePreview.src) // free memory
        }
    };
